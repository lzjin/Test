package com.danqiu.myapplication.fragment.city.base;
...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case VIEW_TYPE_LOCATION:
                view = LayoutInflater.from(mContext).inflate(com.zaaach.citypicker.R.layout.cp_list_item_location_layout, parent, false);
                return new LocationViewHolder(view);
            case VIEW_TYPE_HOT:
                view = LayoutInflater.from(mContext).inflate(com.zaaach.citypicker.R.layout.cp_list_item_hot_layout, parent, false);
                return new HotViewHolder(view);
            default:
                view = LayoutInflater.from(mContext).inflate(com.zaaach.citypicker.R.layout.cp_list_item_default_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        if (holder instanceof LocationViewHolder){
            ...
            mContext.getTheme().resolveAttribute(com.zaaach.citypicker.R.attr.cpGridItemSpace, typedValue, true);
            int space = mContext.getResources().getDimensionPixelSize(com.zaaach.citypicker.R.dimen.cp_grid_item_space);
            int padding = mContext.getResources().getDimensionPixelSize(com.zaaach.citypicker.R.dimen.cp_default_padding);
            int indexBarWidth = mContext.getResources().getDimensionPixelSize(com.zaaach.citypicker.R.dimen.cp_index_bar_width);
            ...
            switch (locateState){
                case LocateState.LOCATING:
                    ((LocationViewHolder) holder).current.setText(com.zaaach.citypicker.R.string.cp_locating);
                    break;
                case LocateState.SUCCESS:
                    ((LocationViewHolder) holder).current.setText(data.getName());
                    break;
                case LocateState.FAILURE:
                    ((LocationViewHolder) holder).current.setText(com.zaaach.citypicker.R.string.cp_locate_failed);
                    break;
            }
    ...
    public static class DefaultViewHolder extends BaseViewHolder{
        ...
        DefaultViewHolder(View itemView) {
            super(itemView);
            name = itemView.findViewById(com.zaaach.citypicker.R.id.cp_list_item_name);
        }
    }
    ...
    public static class HotViewHolder extends BaseViewHolder {
        ...
        HotViewHolder(View itemView) {
            super(itemView);
            mRecyclerView = itemView.findViewById(com.zaaach.citypicker.R.id.cp_hot_list);
            ...
            int space = itemView.getContext().getResources().getDimensionPixelSize(com.zaaach.citypicker.R.dimen.cp_grid_item_space);
    ...
    public static class LocationViewHolder extends BaseViewHolder {
        ...
        LocationViewHolder(View itemView) {
            super(itemView);
            container = itemView.findViewById(com.zaaach.citypicker.R.id.cp_list_item_location_layout);
            current = itemView.findViewById(com.zaaach.citypicker.R.id.cp_list_item_location);
        }
    }
}
