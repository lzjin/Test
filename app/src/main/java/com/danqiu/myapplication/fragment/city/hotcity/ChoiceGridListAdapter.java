 ...
 * @Date: 2018/2/8 21:22
 */
public class ChoiceGridListAdapter extends RecyclerView.Adapter<ChoiceGridListAdapter.GridViewHolder>{
    ...
    public ChoiceGridListAdapter(Context context, List<HotCity> data) {
    ...
    public GridViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.cp_grid_item_layout_s, parent, false);
