 ...
 * Describe ：注释
 */
public class PieChartManaggerUtil {
    public PieChart pieChart;

    public PieChartManaggerUtil(PieChart pieChart) {
    ...
    private void initPieChart() {
        ...
        pieChart.setCenterText("成绩分布"); //设置中间文字
...
//        设置pieChart图表转动阻力摩擦系数[0,1]
    ...
    public void showSolidPieChart(List<PieEntry> yvals, List<Integer> colors) {
        //数据集合
        PieDataSet dataset = new PieDataSet(yvals, "英语成绩");
        //填充每个区域的颜色
